...
export const TABS: Tab[] = [
  { id: "2026", label: "2026 — Scorecard", href: "/dashboard/scorecard", icon: LayoutDashboard },
  { id: "rdo", label: "RDO", href: "/dashboard/rdo", icon: ClipboardList },
  { id: "idp-disciplinas", label: "IDP - Disciplinas", href: "/dashboard/idp", icon: CalendarCheck },
